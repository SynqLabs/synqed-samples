...
- Salesforce: query, update_lead, create_lead, get_opportunity, get_lead
- Beautiful: scrape, extract, summarize (web content extraction)

Example Tasks:
- "Plan a tech conference with 500 attendees and schedule all speaker meetings via Zoom"
- "Research competitor websites and create Salesforce leads for each"
- "Query Salesforce for hot leads and schedule follow-up Zoom meetings"
- "Scrape product pricing from competitor sites and update our CRM"
...
use Zoom, Salesforce, and Beautiful tools automatically!
"""
...
async def main(user_task: str, max_agent_turns: int = 15):
    ...
    if HAS_MCP:
        ...
        print("   This enables ALL agents to use Zoom, Salesforce, and Beautiful tools!")
        print()
        ...
        print(f"   • Available Tools: Zoom, Salesforce, Beautiful")
        print()
        ...
        print("     • await context.mcp.call_tool('salesforce.query', {...})")
        print("     • await context.mcp.call_tool('beautiful.scrape', {...})")
        print()
    ...
    if HAS_MCP and len(agents) > 0 and mcp_endpoint_for_demo:
        ...
        # Test 3: Beautiful - Scrape Website
        try:
        ...
        print("  • Any agent can call Zoom, Salesforce, or Beautiful APIs")
    ...
    if HAS_MCP:
        ...
        print(f"  5. ✅ Every agent can use Zoom, Salesforce, and Beautiful tools")
    ...
    if HAS_MCP:
        ...
        print("  • Agents can schedule Zoom meetings, query Salesforce, scrape websites")
...
- Query Salesforce for potential sponsors
- Research venue options by scraping websites
- Create Salesforce leads for all interested attendees
"""
    
    # Alternative task examples that leverage MCP tools:
    
    # Example 2: Sales automation with Zoom + Salesforce
    ...
    # Example 3: Competitor research with Beautiful + Salesforce
    ...
    # Example 4: Event coordination with Zoom
